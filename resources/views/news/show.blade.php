                ...
                @if($news->hasInstagram() || $news->hasSpotify() || $news->hasFacebook())
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="space-y-8">
                            ...
                            {{-- ── SPOTIFY ─────────────────────────────────── --}}
                            {{-- Fix 3: Spotify bloquea iframes externos por CSP --}}
                            @if($news->hasSpotify())
                                <div>
                                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3 flex items-center gap-2">
                                    ...
                                    <a href="{{ $news->SpotifyUrl }}" target="_blank" rel="noopener noreferrer"
                                       class="inline-flex items-center gap-3 px-5 py-4 rounded-xl w-full justify-center font-semibold text-white transition-all hover:opacity-90 hover:-translate-y-0.5"
